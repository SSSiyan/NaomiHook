...
public:
  ...
  const char* get_description() const override { return R"(A feature heavily inspired by NMH3. This feature restores a small portion of your current beam katana's battery with every successful wrestling QTE.)"; };
