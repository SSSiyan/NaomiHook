...
public:
    ...
    std::string get_human_readable_name() const { return "Draw Hitboxes"; }
    const char* get_description() const override { return R"(View info about hitboxes)"; };
