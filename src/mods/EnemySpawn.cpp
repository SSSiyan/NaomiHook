...
static const char* charaTypeStrings[91] {
  ...
  "eCharaTypeSLV Sylvia", // 2,
  "eCharaTypeNPC", // 3,
  "eCharaTypeNPCNotMove", // 4,
  "eCharaTypeOBJ", // 5,
  "eCharaTypeOBJNotMove", // 6,
  "eCharaTypeZKPipe", // 7,
  "eCharaTypeTGR Shinobu", // 8,
  "eCharaTypeTYG BadGirl", // 9,
  "eCharaTypeJST Destroyman", // 10,
  "eCharaTypeSFF Holly Summers", // 11,
  "eCharaTypeEFL Speedbuster", // 12,
  "eCharaTypeOBJ700", // 13,
  "eCharaTypeMGE Dr.Peace", // 14,
  "eCharaTypeENX", // 15,
  "eCharaTypeMAM Death Metal", // 16,
  "eCharaTypeZKClone", // 17,
  "eCharaTypeTET Harvey", // 18,
  "eCharaTypeGEN Jeane", // 19,
  "eCharaTypeTKL Henry", // 20,
  ...
  "eCharaTypeOBJ631", // 33,
  "eCharaTypeOBJ632", // 34,
  "eCharaTypeMAM_Jr Death Metal Clone", // 35,
  "eCharaTypeHML", // 36,
  "eCharaTypeNZN", // 37,
  ...
  "eCharaTypeZKKakuzai Torch", // 47,
  "eCharaTypeZKBat", // 48,
  "eCharaTypeZKSchop Shovel", // 49,
  "eCharaTypeZKSignboard", // 50,
  "eCharaTypeZKSword Oxtail Sabre", // 51,
  "eCharaTypeZKKaeinbin Molotov", // 52,
  "eCharaTypeOBJ180", // 53,
  "eCharaTypeOBJ181", // 54,
  "eCharaTypeOBJ182", // 55,
