...
namespace nmh_sdk {
	...
	typedef bool(__thiscall* mPlayMotionFunc)(uintptr_t* playerPtr, pcMotion inMotNo, bool inLoop, int inStartFrame, bool inOverWrite, float inInterpolate); // 0x402CF0 // ida says __userpurge
	typedef char(__thiscall* mSetEquipFunc)(uintptr_t* playerPtr, pcItem inID, bool inPowUp); // 0x3E2240
