...
struct HrCamera__MAIN__BATTLE2
{
...
struct HrCamera__MAIN
{
  /* 0x0000 */ enum HRCAMERA_MODE Mode;
  /* 0x0004 */ struct HrCamera__MOVE2 mov2;
  /* 0x003c */ struct HrCamera__MAIN__BATTLE2 bat2;
  /* 0x0080 */ struct HrCamera__MAIN__MOTION motion;
  /* 0x00ac */ struct HrCamera__MAIN__NORMAL nrm;
  /* 0x00cc */ struct HrCamera__MAIN__HOMING homing;
  /* 0x01f4 */ struct HrCamera__MAIN__FREE free;
  /* 0x0210 */ struct HrCamera__MAIN__MOVE mov;
  /* 0x0258 */ struct HrCamera__MAIN__BATTLE bat;
  /* 0x02a8 */ struct HrCamera__MAIN__SHAKE shk;
